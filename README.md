...
7. 🛡️ [Integration point: MCP tools (`ResilientToolCallbackProvider`, `McpTokenService`)](#integration-point-mcp-tools-resilienttoolcallbackprovider-mcptokenservice)
...
13. 🛡️ [Resilience: circuit breakers, retries, timeouts](#resilience-circuit-breakers-retries-timeouts)
...
18. ⚠️ [Known gaps and rough edges](#known-gaps-and-rough-edges)
